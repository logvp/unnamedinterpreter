...
impl Lexer {
    ...
    pub fn lex(text: &str, filename: Option<Symbol>) -> Result<Self, LexicalError> {
            ...
            let token = match c {
                ...
                '_' | 'a'..='z' | 'A'..='Z' => {
                    ...
                    match buffer.as_str() {
                        ...
                        "if" => TokenKind::If,
                        "else" => TokenKind::Else,
                        _ => TokenKind::Identifier(sym(buffer.as_str())),
                    }
                }
                _ => {
                    ...
                    return Err(LexicalError::UnknownToken(sym(buffer.as_str()), loc));
                }
            };
